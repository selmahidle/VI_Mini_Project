...
from preprocessing_better import get_dataloaders
...
print(f"Training Complete. Best Metric: {best_metric.item():.4f} at Epoch: {best_metric_epoch}")
...
plt.ylabel("Loss")
plt.legend()
plt.savefig('unet_loss_u19.png')
plt.show()
print("Loss plot saved as unet_loss_u19.png")
...
plt.legend()
plt.savefig('unet_mean_dice1.png')
plt.show()
print("Mean Dice plot saved as unet_mean_dice1.png")
...
plt.legend()
plt.savefig('unet_per_class_dice1.png')
plt.show()
print("Per-class Dice plot saved as unet_per_class_dice1.png")
